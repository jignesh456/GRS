    ...
    if (isset($_SESSION['username'])) {
      ...
      if (isset($_REQUEST['submit'])) {
        ...
        if ($password == $con_password) {
          ...
          $subject = 'Congratulations | You have been successfully registered as admin in G-Battle'; // Give the email a subject 
          $message = '
           
          Dear '.$fname.',
            You have been successfully registered with G-Battle as Admin. Below are the username and password of yours.
            thanks for using our sevices, we are happy to have you in our G-Battle team. 
          ...
          you can login through the link given below:
          http://www.gbattle.tk/administrator/           
           
          '; // Our message above including the link
                               
          $headers = 'From:G-Battle' . "\r\n"; // Set from headers
